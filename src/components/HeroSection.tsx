  ...
  return (
    <section id="home" className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
        ...
        <p className="font-display text-xl md:text-2xl text-primary-foreground/90 mb-2 animate-fade-in-up leading-relaxed" style={{ animationDelay: "0.2s" }}>
          Il piacere di abitare
        </p>
        <p className="font-display text-xl md:text-2xl text-primary-foreground/90 mb-2 animate-fade-in-up leading-relaxed" style={{ animationDelay: "0.3s" }}>
          nel cuore di Parma
        </p>
        <p className="font-body text-primary-foreground/75 text-base md:text-lg max-w-xl mx-auto mb-8 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
          in una magica atmosfera di storia e stile
        </p>
